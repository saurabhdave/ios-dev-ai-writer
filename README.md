...
[![Version](https://img.shields.io/badge/version-1.6.4-blue?style=flat-square)](CHANGELOG.md)
...
Follows [Semantic Versioning](https://semver.org). Current version: **1.6.4** — see [CHANGELOG.md](CHANGELOG.md).
