...
[![Version](https://img.shields.io/badge/version-1.6.6-blue?style=flat-square)](CHANGELOG.md)
...
Follows [Semantic Versioning](https://semver.org). Current version: **1.6.6** — see [CHANGELOG.md](CHANGELOG.md).
